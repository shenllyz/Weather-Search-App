        ...
        <Col>
          <Tab.Container activeKey={activeTab} onSelect={(k) => setActiveTab(k || 'dailyView')}>
            <Nav variant="tabs" dir='rtl' className='px-0'>
              <Nav.Item>
                <Nav.Link eventKey="meteogram">Meteogram</Nav.Link>
              </Nav.Item>
              <Nav.Item>
                <Nav.Link eventKey="dailyTempChart">Daily Temp. Chart</Nav.Link>
              </Nav.Item>
              <Nav.Item>
                <Nav.Link eventKey="dailyView">Day View</Nav.Link>
              </Nav.Item>
            </Nav>
            <Tab.Content className='mt-3'>
              <Tab.Pane eventKey="meteogram">
                <MeteogramComponent weatherData={hourlyWeatherData} />
              </Tab.Pane>
              <Tab.Pane eventKey="dailyTempChart">
                <DailyTempChart weatherData={dailyWeatherData} />
              </Tab.Pane>
              <Tab.Pane eventKey="dailyView">
